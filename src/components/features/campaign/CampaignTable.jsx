import {
  ...
  Eye, Pencil, Trash2, FileDown, Users
} from "lucide-react";
...
export default function CampaignTable({
  campaigns, loading, sortField, sortOrder,
  onSort, onView, onEdit, onDelete, onExportCodes
}) {
  return (
    <div
              ...
              campaigns.map(c => (
                ...
                >
                  ...
                  <td className="px-4 py-3.5">
                    ...
                    {c.description && (
                      <div className="text-xs mt-0.5 max-w-[200px] truncate" style={{ color: "var(--color-text-muted)" }}>
                        {c.description}
                      </div>
                    )}
                  </td>
                  ...
                  <td className="px-4 py-3.5 font-medium" style={{ color: "var(--color-text-primary)" }}>
                    {c.walls}
                  </td>
                  ...
                  <td className="px-4 py-3.5">
                    <div className="flex items-center gap-1.5">
                      <ActionBtn icon={<Eye size={13} />} title="View" color="var(--color-primary)" onClick={() => onView(c)} />
                      <ActionBtn icon={<Pencil size={13} />} title="Edit" color="var(--color-secondary)" onClick={() => onEdit(c)} />
                      <ActionBtn icon={<FileDown size={13} />} title="Export Codes" color="#10b981" onClick={() => onExportCodes(c)} />
                      <ActionBtn icon={<Trash2 size={13} />} title="Delete" color="#ef4444" onClick={() => onDelete(c)} />
                    </div>
                  </td>
                </tr>
              ))
